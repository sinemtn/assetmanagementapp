        ...
        <div class="flex mb-4 gap-6">
            <div class="w-1/2">
                ...
                <div class="relative w-full mb-4">
                    <!-- Input field -->
                    <input v-model="caricustomer" type="text" placeholder="Cari Customer"
                    ...
                    <!-- Search button -->
                    <button type="button" @click="toggleSearchCustomer"
