    ...
    <div>
        <div class="flex justify-between">
            ...
            <div
                ...
                <router-link to="/settings/masterdata/location/tambah" class="block">
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th class="px-5 py-3 text-left w-2/11 sm:px-6">
                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Printer</p>
                        </th>
                        <th class="px-5 py-3 text-left w-2/11 sm:px-6">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <td class="px-5 py-4 sm:px-6">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">Warehouse</p>
                        </td>
                        <td class="px-5 py-4 sm:px-6">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">KSO</p>
                        </td>
                        <td class="px-5 py-4 sm:px-6">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">Beli Putus</p>
                        </td>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <router-link to="/surattugas-detail" class="edit-button">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        a48.108 48.108 0 0 1 3.478-.397m7.5 0
                                        a48.11 48.11 0 0 1 3.478.397m-10.956 0
                                        V4.5c0-1.18.91-2.164 2.09-2.201
                                        a51.964 51.964 0 0 1 3.32 0
                                        c1.18.037 2.09 1.022 2.09 2.201v1.125M4.772 5.79
                                        L5.82 19.673c.078 1.04.943 1.827 1.989 1.827h8.383
                                        c1.046 0 1.91-.787 1.989-1.827L19.228 5.79" />
                                    </svg>
                                    Delete
                                </router-link>
                    ...
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <td class="px-5 py-4 sm:px-6">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">workshop</p>
                        </td>
                        <td class="px-5 py-4 sm:px-6">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">Beli Putus</p>
                        </td>
...
const savePlusToner = () => {
    console.log('Toner Ditambahkan')
    isPlusToner.value = false
}

const isMinusToner = ref(false)

const saveMinusToner = () => {
    console.log('Profile saved')
    isMinusToner.value = false
}
